...
<body>
    ...
    <section id="home">
        ...
        <div class="about-content">
            <h2>About Us</h2>
            <p>Welcome to CarRental, Malawi's premier car rental platform. Established in 2025, we've revolutionized the way people rent and share vehicles in our community. Our mission is to provide reliable, secure, and convenient car rental services while maintaining the highest standards of customer satisfaction.</p>
            <h3>Our Services</h3>
            <ul>
